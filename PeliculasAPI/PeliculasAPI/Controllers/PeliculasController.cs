...
namespace PeliculasAPI.Controllers
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        [HttpGet(Name = "Filtro1")]
        public async Task<ActionResult<PeliculasIndexDTO>> Filtro()
        {
            var top = 5;
        ...
        [HttpGet("filtro")]
        public async Task<ActionResult<List<PeliculasDTO>>> Filtrar([FromQuery] FiltroPeliculaDTO filtroPeliculasDTO)
        {
